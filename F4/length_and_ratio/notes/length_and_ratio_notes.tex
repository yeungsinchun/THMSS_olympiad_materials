...
\end{proof}
\begin{question}
	Prove the Trigonometric Form of Ceva's Theorem.
\end{question}
\vspace{5cm}
...
\begin{mdframed}
	...
	\begin{figure}[H]
		...
		\end{tikzpicture}
		\caption{Statement of Median Division}
	\end{figure}
\end{mdframed}
\begin{proof}
...
\end{proof}
\begin{question}
	Prove that the medians divide the triangle into $6$ equal parts.
\end{question}
\vspace{5cm}

\begin{question}
	(Centroid Division) Show that $AG=2GM,GC=2LG,BG=2GN$.
\end{question}
\vspace{5cm}
\newpage
